...
const marvel = ['Spiderman', 'Viúva Negra', 'Jean Grey', 'Iron Man', 'Carol Danvers', 'Hulk', 'Wolwerine'];
const dc = ['Batman', 'Katana', 'Batgirl ', 'Wonder Woman', 'Aquaman', 'Flash', 'Arqueiro Verde', ...marvel];
// console.log(dc)
// Rest
...
// console.log(p)
// Template String
const usuarioID = 'Batman';
const notificacoes = '20';
const bemVindo = `
    Bem Vindo ${usuarioID}, 
